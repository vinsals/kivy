...
like so ::
    ...
    <Selector>
        color: 0, 1, 0, 1
        # or <Textinput_instance>.selecion_color or app.selection_color

TextInput instanciates the selection handles and stores it in the following
properties. :attr:`TextInput.selection_middle`,
:attr:`TextInput.selection_left`, :attr:`TextInput.selection_right`.

You should set the selection template before the Instanciating TextInput,
...
class Selector(ButtonBehavior, Image):
    ...
    you should adjust it's template like so ::
